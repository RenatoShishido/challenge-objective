...
public class Jogo {
	...
	public void inserir(String pergunta, String prato, No prato_atual) {
		No novo_prato = new No(prato, null, null);
		No nova_pergunta = new No(pergunta, novo_prato , prato_atual);
		No pergunta_anterior = prato_atual.getAnterior();
		
		setPerguntaNova(prato_atual, pergunta_anterior, nova_pergunta);
		setAnterior(prato_atual, pergunta_anterior, nova_pergunta, novo_prato);
	}
